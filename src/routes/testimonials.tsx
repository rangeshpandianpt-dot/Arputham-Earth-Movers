...
export const Route = createFileRoute("/testimonials")({
  head: () => ({
    meta: [
      { title: "Testimonials — Arputham Earth Movers" },
      { name: "description", content: "Read what builders and contractors across Tamil Nadu say about working with Arputham Earth Movers." },
      { property: "og:title", content: "Testimonials — Arputham Earth Movers" },
    ...
    <>
      <section className="container-px mx-auto max-w-7xl py-16 md:py-24">
        <SectionHeading
          ...
          title="Trusted by builders across Tamil Nadu"
          subtitle="Real stories from real contractors and builders we've worked with."
        />
        <Testimonials />
