      ...
      <div className="pointer-events-auto fixed bottom-5 right-5 flex flex-col gap-3">
        {show && (
          <button
            ...
            className="grid h-12 w-12 place-items-center rounded-full bg-card border border-border text-foreground shadow-elegant transition-transform hover:scale-105"
          >
            <ArrowUp size={18} />
          </button>
        )}
